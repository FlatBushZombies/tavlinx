    ...
    <div className="fixed right-4 bottom-6 z-50">
      ...
      >
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          <path d="M20.52 3.478A11.856 11.856 0 0 0 12 0C5.373 0 0 5.373 0 12c0 2.11.55 4.074 1.6 5.83L0 24l6.39-1.65A11.893 11.893 0 0 0 12 24c6.627 0 12-5.373 12-12 0-1.9-.416-3.7-1.48-5.322z" fill="#fff" opacity="0.06"/>
